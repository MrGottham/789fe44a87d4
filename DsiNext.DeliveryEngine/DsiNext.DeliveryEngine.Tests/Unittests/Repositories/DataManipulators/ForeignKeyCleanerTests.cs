...
{
    /// <summary>
    /// Tests worker to clean missing foreign key valus.
    /// </summary>
    [TestFixture]
    public class ForeignKeyCleanerTests
    {
        /// <summary>
        /// Tests that the constructor initialize the worker to clean missing foreign key valus.
        /// </summary>
        [Test]
        public void TestThatConstructorInitializeWorker()
        {
            ...
            var worker = new ForeignKeyCleaner(dataSourceMock.Tables.ElementAt(1).NameTarget, fixture.CreateMany<string>(5).ToList(), fixture.CreateAnonymous<IMetadataRepository>(), fixture.CreateAnonymous<IInformationLogger>());
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfTargetTableNameIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ForeignKeyCleaner(null, fixture.CreateMany<string>(5).ToList(), fixture.CreateAnonymous<IMetadataRepository>(), fixture.CreateAnonymous<IInformationLogger>()));
        }
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfTargetTableNameIsEmpty()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ForeignKeyCleaner(string.Empty, fixture.CreateMany<string>(5).ToList(), fixture.CreateAnonymous<IMetadataRepository>(), fixture.CreateAnonymous<IInformationLogger>()));
        }
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfForeignKeyFieldsIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ForeignKeyCleaner(dataSourceMock.Tables.ElementAt(0).NameTarget, null, fixture.CreateAnonymous<IMetadataRepository>(), fixture.CreateAnonymous<IInformationLogger>()));
        }
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfMetadataRepositoryIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ForeignKeyCleaner(fixture.CreateAnonymous<string>(), fixture.CreateMany<string>(5).ToList(), null, fixture.CreateAnonymous<IInformationLogger>()));
        }
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfInformationLoggerIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ForeignKeyCleaner(dataSourceMock.Tables.ElementAt(0).NameTarget, fixture.CreateMany<string>(5).ToList(), fixture.CreateAnonymous<IMetadataRepository>(), null));
        }
        ...
        public void TestThatConstructorThrowsDeliveryEngineSystemExceptionIfTargetTableNameNotInDataSource()
        {
            ...
            var exception = Assert.Throws<DeliveryEngineSystemException>(() => new ForeignKeyCleaner(fixture.CreateAnonymous<string>(), fixture.CreateMany<string>(5).ToList(), fixture.CreateAnonymous<IMetadataRepository>(), fixture.CreateAnonymous<IInformationLogger>()));
        ...
        /// <summary>
        /// Tests that Manipulate cleans missing foreign key values.
        /// </summary>
        [Test]
        public void TestThatManipulateCleansMissingForeignKeyValues()
        {
            ...
            var worker = new ForeignKeyCleaner(secondaryTable.NameTarget, new List<string> {primaryTable.Fields.ElementAt(primaryTable.Fields.Count - 3).NameSource, primaryTable.Fields.ElementAt(primaryTable.Fields.Count - 2).NameSource, primaryTable.Fields.ElementAt(primaryTable.Fields.Count - 1).NameSource}, fixture.CreateAnonymous<IMetadataRepository>(), fixture.CreateAnonymous<IInformationLogger>());
            Assert.That(worker, Is.Not.Null);
            ...
            dataRepositoryMock.OnHandleData += (s, e) =>
                {
                    ...
                    Assert.That(manipulatedData.Count, Is.EqualTo(primaryTableData.Count));
                    foreach (var manipulatedDataRow in manipulatedData)
                    {
                        manipulatedDataRow.Last().AssertWasCalled(m => m.UpdateSourceValue(Arg<object>.Is.Equal(null)));
                    }
                };
            // ReSharper restore ImplicitlyCapturedClosure
