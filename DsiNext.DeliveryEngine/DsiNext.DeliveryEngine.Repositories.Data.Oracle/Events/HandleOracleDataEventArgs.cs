...
{
    /// <summary>
    /// Arguments to the event raised when to handle data from a oracle data repository.
    /// </summary>
    public class HandleOracleDataEventArgs : EventArgs, IHandleDataEventArgs
    {
        ...
        public HandleOracleDataEventArgs(ITable table, IEnumerable<IEnumerable<IDataObjectBase>> data, bool endOfData)
        {
            if (table == null)
            {
