...
{
    /// <summary>
    /// Tests the configuration provider for repository to write the delivery format.
    /// </summary>
    [TestFixture]
    public class ArchiveVersionRepositoryConfigurationProviderTests
    {
        ...
        /// </summary>
        [Test]
        public void TestConfiguration([Values(typeof(IContainer), typeof(IArchiveVersionRepository))] Type type)
        {
