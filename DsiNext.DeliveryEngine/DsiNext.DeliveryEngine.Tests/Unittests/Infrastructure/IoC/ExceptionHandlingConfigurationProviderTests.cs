...
{
    /// <summary>
    /// Tests the configuration provider for exception handling.
    /// </summary>
    [TestFixture]
    public class ExceptionHandlingConfigurationProviderTests
    {
        ...
        /// </summary>
        [Test]
        public void TestConfiguration([Values(typeof(IContainer), typeof(IExceptionHandler))] Type type)
        {
