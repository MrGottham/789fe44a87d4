...
{
    /// <summary>
    /// Tests the configuration provider for data repository.
    /// </summary>
    [TestFixture]
    public class DataRepositoryConfigurationProviderTests
    {
        ...
        /// </summary>
        [Test]
        public void TestConfiguration([Values(typeof(IContainer), typeof(IDataRepository))] Type type)
        {
