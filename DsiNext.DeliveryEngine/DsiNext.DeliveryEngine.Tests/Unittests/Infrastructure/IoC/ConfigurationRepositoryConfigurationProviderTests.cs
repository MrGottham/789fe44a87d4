...
{
    /// <summary>
    /// Tests the configuration provider for configuration repository.
    /// </summary>
    [TestFixture]
    public class ConfigurationRepositoryConfigurationProviderTests
    {
        ...
        /// </summary>
        [Test]
        public void TestConfiguration([Values(typeof(IContainer), typeof(IConfigurationRepository))] Type type)
        {
