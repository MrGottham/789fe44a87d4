...
{
    /// <summary>
    /// Tests configuration provider for a mapping data validator.
    /// </summary>
    [TestFixture]
    public class MappingDataValidatorConfigurationProviderTests
    {
        ...
        /// </summary>
        [Test]
        public void TestConfiguration([Values(typeof(IContainer), typeof(IMappingDataValidator))] Type type)
        {
