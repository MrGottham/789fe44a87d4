...
{
    /// <summary>
    /// Arguments to the event raised before validating data in a target table.
    /// </summary>
    public class ValidateDataInTargetTableEventArgs : EventArgs, IValidateDataInTargetTableEventArgs
    {
        ...
        /// <summary>
        /// Creates arguments to the event raised before validating data in a target table.
        /// </summary>
        /// <param name="dataSource">Data source.</param>
        /// <param name="targetTable">Target table.</param>
        /// <param name="dataBlock">Data block number.</param>
        /// <param name="rowsInDataBlock">Rows in the data block.</param>
        public ValidateDataInTargetTableEventArgs(IDataSource dataSource, ITable targetTable, int dataBlock, int rowsInDataBlock)
        {
            if (dataSource == null)
            {
