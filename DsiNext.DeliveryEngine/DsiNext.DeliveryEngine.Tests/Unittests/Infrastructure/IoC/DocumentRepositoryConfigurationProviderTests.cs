...
{
    /// <summary>
    /// Tests the configuration provider for document repository.
    /// </summary>
    [TestFixture]
    public class DocumentRepositoryConfigurationProviderTests
    {
        ...
        /// </summary>
        [Test]
        public void TestConfiguration([Values(typeof(IContainer), typeof(IDocumentRepository))] Type type)
        {
