...
{
    /// <summary>
    /// Tests arguments to the event raised before archiving data in a target table.
    /// </summary>
    [TestFixture]
    public class ArchiveDataForTargetTableEventArgsTests
    {
        /// <summary>
        /// Test that the constructor initialize arguments to the event raised before archiving data in a target table.
        /// </summary>
        [Test]
        public void TestThatConstructorInitializeEventArgs()
        {
            ...
            var eventArgs = new ArchiveDataForTargetTableEventArgs(dataSourceMock, targetTableMock, dataBlock, rowsInDataBlock);
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfDataSourceIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ArchiveDataForTargetTableEventArgs(null, fixture.CreateAnonymous<ITable>(), fixture.CreateAnonymous<int>(), fixture.CreateAnonymous<int>()));
        }
        ...
        public void TestThatConstructorThrowsArgumentNullExceptionIfTargetTableIsNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new ArchiveDataForTargetTableEventArgs(fixture.CreateAnonymous<IDataSource>(), null, fixture.CreateAnonymous<int>(), fixture.CreateAnonymous<int>()));
        }
    }
}
