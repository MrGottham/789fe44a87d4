...
namespace DsiNext.DeliveryEngine.BusinessLogic.Commands
{
    ...
    public class DeliveryEngineExecuteCommand : IDeliveryEngineExecuteCommand
    {
        ...
        /// </summary>
        public virtual string OverrideArchiveInformationPackageId
        {
            get;
            set;
        }
        ...
        /// </summary>
        public virtual bool ValidationOnly
        {
            get;
            set;
        }
        ...
        public virtual int TablesHandledSimultaneity
        {
            get
            {
                return _tablesHandledSimultaneity;
            }
            set
            {
                _tablesHandledSimultaneity = value;
            }
        }
        ...
        /// </summary>
        public virtual bool RemoveMissingRelationshipsOnForeignKeys
        {
            get;
            set;
        }
        ...
        public virtual int NumberOfForeignTablesToCache
        {
            get
            {
                return _numberOfForeignTablesToCache;
            }
            set
            {
                _numberOfForeignTablesToCache = value;
            }
        }
